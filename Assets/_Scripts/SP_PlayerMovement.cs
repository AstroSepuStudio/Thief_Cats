...
public class SP_PlayerMovement : MonoBehaviour
{
    enum MovementState { Idle, Walk, Sprint, Crouch, OnAir }

    [Header("References")]
    [SerializeField] PlayerData _pData;
    [SerializeField] CharacterController _charCtr;
    ...
    private void StartCrouch()
    {
        ...
        _charCtr.height = _crouchHeight;
        _charCtr.center = _crouchCenter;
    ...
    private void StopCrouch()
    {
        ...
        _charCtr.height = _defaultHeight;
        _charCtr.center = _defaultCenter;
    ...
    void Update()
    {
        ...
        _charCtr.Move(_yVelocity * Vector3.up);
        _charCtr.Move(_movVector);
    }
